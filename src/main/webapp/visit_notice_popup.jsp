...
<%
	...
	String sql = "SELECT DATE_ADD(notice_date, INTERVAL 10 DAY) > NOW() AS new_yn, A.* FROM TVst_Notice A WHERE notice_code = " +"'"+ dtl_code +"'";
	...
	try {
		...
		while(md.rs.next()) { 
			notice_title = md.rs.getString("notice_title");
			notice_code = md.rs.getString("notice_code");
			notice_content = md.rs.getString("notice_content");
		}
		...
		<div class="card mt-3 mb-3">
			<div class="card-header">
				<table style="width:100%;">
					<tr>
						<td>
							<input name="notice_title" id="notice_title" type="text" value="<%=notice_title%>" style="border:0; background-color:transparent; width:100%;" disabled="disabled" />
							<input name="notice_code" id="notice_code"type="text" value="<%=notice_code%>" style="display:none;" />
						</td>
					</tr>
				</table>
			</div>
			...
			<div class="card-body" style="min-height:400px;">
				<!-- 본문 -->
				<div class="grp-box-p"><%=notice_content%></div>
			</div>
		</div>
